...
const projects = [
  ...
  },
  {
    ...
    link: "https://github.com/Anas16-10/Cartoonify-image"
  }
];
  ...
  return (
    <section id="projects" className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 justify-items-center md:justify-items-stretch">
        {projects.map((p, idx) => (
          <Reveal key={p.title} delay={idx * 0.05} className="w-full md:w-auto">
            <a href={p.link} target="_blank" rel="noreferrer" className="w-full md:w-auto block">
